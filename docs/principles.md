...
| **Semantic Versioning 2.0** | release-please prepares version metadata; validated immutable tags originate on canonical Gitea; breaking changes force major bump via `!` / `BREAKING CHANGE:` |
