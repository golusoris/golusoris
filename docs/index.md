...
- **[Capability contract](../capabilities.yaml)** — every package → capability keys → replaced modules; what praetor `needs` resolves against.
- **[Licensing](../LICENSING.md)** — EUPL-1.2 code, CC-BY-SA-4.0 prose, REUSE, DCO.
